        ...
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
            ...
            <View style={styles.container}>
                ...
                <View style={styles.component1}>
                    <Text style={styles.titleEmail}>Choose a password</Text>
                    <TextInput
                        style={styles.input}
                    ...
                    />
                    <Text style={{color: '#8d8e8e'}}>Your password must be at least 8 characters</Text>
                ...
                <View style={{justifyContent: 'flex-end', alignItems: 'center', width: '100%',}}>
                    <Button
                        ...
                        onPress={() => {
                            navigation.navigate({name:'SignUpName'});
                        }}
                    />    
                </View> 
            </View>
